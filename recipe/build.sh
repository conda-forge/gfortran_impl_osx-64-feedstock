...
if [[ "$target_platform" == osx* ]]; then
    ...
    export CFLAGS_FOR_TARGET="$CFLAGS_FOR_TARGET -isysroot $CONDA_BUILD_SYSROOT $LDFLAGS_FOR_TARGET"
    export CXXFLAGS_FOR_TARGET="$CXXFLAGS_FOR_TARGET -isysroot $CONDA_BUILD_SYSROOT $LDFLAGS_FOR_TARGET"
    export CPPFLAGS_FOR_TARGET="$CPPFLAGS_FOR_TARGET -isysroot $CONDA_BUILD_SYSROOT $LDFLAGS_FOR_TARGET"
fi
